...
<input style="width: calc(100% - 10px);margin-bottom: 10px;max-width: 500px;" class="input_them" name="tenT" placeholder=" Ghi tên truyện vào" type="text" value="<?php echo $row['TenTruyen'] ?>">
</td>
</tr>
...
<input style="width: calc(100% - 10px);margin-bottom: 10px;max-width: 210px;" name="tg" type="text" value="<?php echo $row['TacGia'] ?>">
</td>
</tr>

<tr>
<td class="td_"><b><span style="font-size: 15;margin-bottom: 5px;margin-top: 15px;">Người thực hiện: </span></b>
<input value = "<?php echo $row['NguoiTH'] ?>"style="width: calc(100% - 10px);margin-bottom: 10px;max-width: 350px;" class="input_them" placeholder=" Ghi tên người thực hiện truyện này" name="nth" type="text" value>
</td>
</tr>
<tr>
...
<textarea rows="10" cols="50" style="width: calc(100% - 10px);padding: 7px 5px;margin-bottom: 10px;max-width: 500px;height: 240px;" name="tomtat" > <?php echo $row['TomTat'] ?></textarea>
</td>
</tr>

<tr>
<td class="td_" colspan="2"><input name="fix" type="submit" value="Sửa"  style="height: 35px;width: 120px;margin-bottom: 7px;"></td>
</td>
</tr>
<?php } ?>
</table>
