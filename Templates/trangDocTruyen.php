...
<div class='n-prev'>
    <a class='b-prev'  
    href="index.php?task=<?php if($_GET['task'] == 'UserDoctruyen') echo "UserDoctruyen"; 
    else { echo "GuestDoctruyen";}?>&IDtr=<?php echo $_GET['IDtr']?>&IDchap=<?php echo "$prev"?>"><img src='Templates/HinhAnh/prevc.png' style='cursor: pointer;' />
        </a></div>

        <select class="form-control" name="chapters">
            <?php foreach($resultCHn as $row){ ?>
<option selected  ><?php echo $row['TenChap'] ?></option> 
<?php } ?>
</select>

<div class="n-next">
 <a href="index.php?task=<?php if($_GET['task'] == 'UserDoctruyen') echo "UserDoctruyen"; 
    else { echo "GuestDoctruyen";}?>&IDtr=<?php echo $_GET['IDtr']?>&IDchap=<?php echo "$next"?>">
...
<div class='n-prev'>
    <a class='b-prev'  href="index.php?task=<?php if($_GET['task'] == 'UserDoctruyen') echo "UserDoctruyen"; 
    else { echo "GuestDoctruyen";}?>&IDtr=<?php echo $_GET['IDtr']?>&IDchap=<?php echo "$prev"?>"><img src='Templates/HinhAnh/prevc.png' style='cursor: pointer;' />
        </a></div>

 <select class="form-control" name="chapters" >
<option value="index.php?task=<?php if($_GET['task'] == 'UserDoctruyen') echo "UserDoctruyen"; 
    else { echo "GuestDoctruyen";}?>&IDtr=<?php echo $row['IDtruyen']?>&IDchap=<?php echo $row['IDc']?>">Chap 2</option>
