...
<div id="wrapper">
        <div id="header">
            ...
            <div id="menu">
                <div class="item">
                    <a href="index.php?task=PageHomeUser">Trang chủ</a>
                </div>
...
?>
        ...
        <a href="index.php?task=UserDoctruyen&IDtr=<?php echo $row['IDtruyen']?>&IDchap=<?php echo $row['IDc']?>"><img src="Templates/HinhAnh/<?php echo $r['AnhBia']?>" alt="" style="width: 220px;">
            <h4>Đọc truyện</h4></a>
        </div>
        <?php }}?>
</div>  
...
<tr>
    <td style="width: 70%; ">
        <a href="index.php?task=UserDoctruyen&IDtr=<?php echo $row['IDtruyen']?>&IDchap=<?php echo $row['IDc']?>"><h2  title="" style="float: left;"><?php echo $row['TenChap'] ;?></h2></a>
        <hr color="#2c2c2c" />
    </td>
